...
namespace AGEMain
{
    ...
    {
        Color beginColor = Color.FromArgb(100, 153, 204, 255);
        Color endColor = Color.FromArgb(100, 44, 82, 147);
        int wid = 10;//色差
        int curindex = 0;
        Timer timer;
        int instervel = 200; //旋转速度
        ...
        void drawString(Graphics g)
        {
            ...
            g.DrawString(loadStr, Font, Brushes.AliceBlue, rect, sf);
        }
